...
resource "aws_subnet" "public" {
  ...
  tags = "${merge(map("Name", format("%s-${var.public_subnet_suffix}-%s", var.name, element(var.azs, count.index))), var.tags, var.public_subnet_tags), "public"}"
}
...
resource "aws_subnet" "private" {
  ...
  tags = "${merge(map("Name", format("%s-${var.private_subnet_suffix}-%s", var.name, element(var.azs, count.index))), var.tags, var.private_subnet_tags, "private")}"
}
